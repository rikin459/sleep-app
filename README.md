...
### Sleep App Project 
### Rikin Patel
### Web app Link: https://sleep-app-198d4.web.app/
...
* Using the following web app link 
* When at the login page register by clicking on the register button. Then enter a valid email and password then the user will be able to sign in.  
* The dashboard will show information on the account if there is any in there and if there is no data you can add it by using Add Sleep function.
* Below in the appendix shows an account with dummy data and all the functions of the sleep app.
...
When creating big projects, it's important to use methodologies. For the first half of this project I use the design thinking methodology which helped me identify the user’s needs and create a prototype. However, it is important to also use a development methodology which will help you create the actual  application when you come to that stage. So before building the application I decided to choose a methodology that would suit my project well and I decided to choose the [waterfall methodology](https://business.adobe.com/blog/basics/waterfall#:~:text=The%20Waterfall%20methodology%20%E2%80%94%20also%20known,before%20the%20next%20phase%20begins.). This methodology was split into five parts. The methodology works by completion of each step for example requirements stage should be completed before moving on desgin stage. 

1. Requirements: the first point of the methodology is required this is where you would gather the information on the requirements of your project for example for my project it would be the requirements of the user’s needs for example what they need in the app like sleep metrics Therefore all requirements were garthered before moving to the next step.


2. Design: This would be where the first draft of designs is created and the final designs of the project. For my project the designs were created in Figma which is a tool that you can create prototypes. This was also done in the first half of the project. Then the design of the prototype was used to create the pages on the actual web app. This helps as when creating the web app i have a desgin and colour theme to follow which allows me to invest my time in just bulidng the application and not thinking about the structure or design. 
 
3. Implementation: the implementation part of the waterfall methodology is where once those two steps are completed, we can move forward to the implementation part. In the implementation part, you would use the requirements and the design part of the project to create your project. For my project, I used the requirements of the users needs which I got from the survey and the design prototype which was made in Figma to create the actual application. This was done using javascript and react. 

4. Verification and testing: This is part of the methodology once we have completed the implementation. Once the project is created one can start the verification and testing of the project which will give great insights into improvements or any bugs if it's a software project. For my once completing the project, I did some verification improvements and decided to test the project to see if every feature that I implemented is working. In this part of the methodology I also added some small finishing touches.
 
5. Deployment and maintenance: Lastly when the project is created deployment and maintenance will be the next step this means deploying the application of the project that you're working on and also maintaining it to keep it running. For my project I had to deploy the application which was done  in this part of the stage also there were a couple of changes that I decided to make which we're done also at this point as they were fairly minor choices and changes. I also did another test on the application for any bugs or errors 




## [User Story](https://www.ba-squared.com/blog/user-stories-you-dont-have-to-be-agile-to-use-them/)
...
Appendix  A shows the firebase authentication 
<img width="1440" alt="Screenshot 2023-01-12 at 17 59 30" src="https://user-images.githubusercontent.com/72072104/212143784-e6e9dc11-3cef-46d3-94e4-f2771e329b17.png">


Appendix  B shows the screenshots of the dummy data and app functions 
<img width="1440" alt="Screenshot 2023-01-12 at 17 59 48" src="https://user-images.githubusercontent.com/72072104/212143941-7da15393-e750-4468-83ca-505df60f3679.png">
<img width="1440" alt="Screenshot 2023-01-12 at 17 59 42" src="https://user-images.githubusercontent.com/72072104/212143976-77da0f85-d90e-48a5-b179-aed6302b1a02.png">
<img width="1440" alt="Screenshot 2023-01-12 at 17 59 45" src="https://user-images.githubusercontent.com/72072104/212144004-f6575907-9cb4-4d28-a90e-d7f64e72d9af.png">



Appendix  C shows the firebase deployment 
<img width="1440" alt="Screenshot 2023-01-12 at 18 03 43" src="https://user-images.githubusercontent.com/72072104/212144425-5883ea27-61dd-499a-9836-1349a3076b24.png">
